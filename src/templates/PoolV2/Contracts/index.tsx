...
import metaMaskIcon from '@assets/logos/metamask.svg'
    ...
    <S.Contracts>
      {pool.pool_version === 2 && (
        <S.ContractsContainer>
          <S.Title>Balancer v2 Vault address</S.Title>
          <S.ContractInfo>
            <S.Blockchain>
              ...
              <S.ContractName>VAULT ID</S.ContractName>
            </S.Blockchain>
            <S.CopyContract>
              <CopyToClipboard text={pool.vault_id || ''}>
                <button
                  type="button"
                  onClick={() => {
                    handleCopyLink()
      ...
      <S.ContractsContainer>
        <S.Title>{pool.chain?.name} CONTRACTS</S.Title>
        <S.ContractInfo>
          <S.Blockchain>
            <S.PoolImageContainer>
              <Image
            ...
            >
              <S.ContractName>CONTROLLER/{pool.symbol} TOKEN</S.ContractName>
              <svg
                width="16"
                height="16"
                viewBox="0 0 17 17"
